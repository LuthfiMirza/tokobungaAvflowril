...
$('.minicart-btn').on('click', function(e) {
    e.preventDefault();
    const $cartWrapper = $(this).siblings('.cart-item-wrapper');
    $cartWrapper.toggleClass('show');
});

// Menutup keranjang ketika klik di luar area
$(document).on('click', function(e) {
    if (!$(e.target).closest('.minicart-wrap').length) {
        $('.cart-item-wrapper').removeClass('show');
    }
});